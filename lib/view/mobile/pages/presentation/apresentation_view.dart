...
class MobileAprensentationView extends StatelessWidget {
  const MobileAprensentationView({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            ButtonLarge(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, AppRoute.MOBILE_HOME);
                }),
            SignSignup(
